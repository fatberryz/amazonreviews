...
def get_outstanding_profiles():
    """
    Retries crawling the outstanding products that were unable to be retrieved in get_reviews. Updates the outstanding
    logs after every try.
    """
...
def parse_args():
    ...
    p.add_argument("-m", "--scraping_mode", default="profiles",
                   help="Specify mode of scraper ['reviews','profiles']")
